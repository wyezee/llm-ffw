"""Bounded configuration for deterministic E.164-style phone inspection."""
...
class PhoneNumberConfig:
    """Directions and limits for conservative E.164-style phone inspection."""
