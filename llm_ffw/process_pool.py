...
class ProcessScannerPool:
    ...
    def __init__(
        ...
        *,
        ...
        self._credential_assignment_config = credential_assignment_config
    ...
    @property
    def credential_assignment_config(
        self,
    ) -> CredentialAssignmentConfig | None:
        return self._credential_assignment_config
