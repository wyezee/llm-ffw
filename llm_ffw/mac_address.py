"""Bounded configuration for deterministic MAC-address inspection."""
...
class MACAddressConfig:
    """Directions and resource limits for canonical 48-bit MAC addresses."""
