"""Bounded configuration for connection-string credential inspection."""
...
_HARD_MAX_CONNECTION_CHARS = 262_144
...
class ConnectionStringConfig:
    """Directions and resource limits for DSN credential inspection."""

    max_candidates: int = 128
    max_credential_chars: int = 8_192
    max_connection_chars: int = 65_536
    ...
    def __post_init__(self) -> None:
        limits = (
            ...
            (
                ...
                self.max_connection_chars,
                _HARD_MAX_CONNECTION_CHARS,
            ),
        )
        ...
        if self.max_connection_chars < self.max_credential_chars:
            raise ValueError(
                "max_connection_chars must be at least max_credential_chars"
            )
